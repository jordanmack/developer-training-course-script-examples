...
// Error Codes
const ERROR_FULLCOUNTER_VALUE_OVERFLOW: i8 = 5;
const ERROR_FULLCOUNTER_INVALID_TRANSACTION_STRUCTURE: i8 = 6;
const ERROR_FULLCOUNTER_INVALID_INPUT_CELL_DATA: i8 = 7;
const ERROR_FULLCOUNTER_INVALID_OUTPUT_CELL_DATA: i8 = 8;
const ERROR_FULLCOUNTER_INVALID_COUNTER_VALUE: i8 = 9;

#[test]
fn test_fullcounter_burn()
{
	// Create Context
	...
	let out_point_counter = context.deploy_cell(Loader::default().load_binary("fullcounter"));

	// Prepare Cell Deps
	let always_success_dep = CellDep::new_builder().out_point(out_point_always_success.clone()).build();
	let fullcounter_dep = CellDep::new_builder().out_point(out_point_counter.clone()).build();
...
#[test]
fn test_fullcounter_burn_multiple()
{
	// Create Context
	let mut context = Context::default();
	...
	assert_error_eq!(err, ScriptError::ValidationFailure(ERROR_FULLCOUNTER_INVALID_TRANSACTION_STRUCTURE).input_type_script(0));
}

#[test]
fn test_fullcounter_create()
{
	// Create Context
	let mut context = Context::default();
...
#[test]
fn test_fullcounter_create_no_output_data()
{
	// Create Context
	let mut context = Context::default();
	...
	// Run
	let err = context.verify_tx(&tx, MAX_CYCLES).unwrap_err();
	assert_error_eq!(err, ScriptError::ValidationFailure(ERROR_FULLCOUNTER_INVALID_OUTPUT_CELL_DATA).output_type_script(0));
}

#[test]
fn test_fullcounter_create_invalid_output_data_value()
{
	// Create Context
	let mut context = Context::default();
...
#[test]
fn test_fullcounter_create_invalid_output_data()
{
	// Create Context
	let mut context = Context::default();
...
#[test]
fn test_fullcounter_transfer_high_value()
{
	// Create Context
	let mut context = Context::default();
...
#[test]
fn test_fullcounter_transfer_plus_2()
{
	// Create Context
	let mut context = Context::default();
	...
	// Run
	let err = context.verify_tx(&tx, MAX_CYCLES).unwrap_err();
	assert_error_eq!(err, ScriptError::ValidationFailure(ERROR_FULLCOUNTER_INVALID_COUNTER_VALUE).input_type_script(0));
}

#[test]
fn test_fullcounter_transfer_plus_9000()
{
	// Create Context
	let mut context = Context::default();
...
#[test]
fn test_fullcounter_transfer_minus_1()
{
	// Create Context
	let mut context = Context::default();
...
#[test]
fn test_fullcounter_transfer_overflow()
{
	// Create Context
	let mut context = Context::default();
	...
	// Run
	let err = context.verify_tx(&tx, MAX_CYCLES).unwrap_err();
	assert_error_eq!(err, ScriptError::ValidationFailure(ERROR_FULLCOUNTER_VALUE_OVERFLOW).input_type_script(0));
}

#[test]
fn test_fullcounter_transfer_invalid_input_data()
{
	// Create Context
	let mut context = Context::default();
	...
	// Run
	let err = context.verify_tx(&tx, MAX_CYCLES).unwrap_err();
	assert_error_eq!(err, ScriptError::ValidationFailure(ERROR_FULLCOUNTER_INVALID_INPUT_CELL_DATA).input_type_script(0));
}

#[test]
fn test_fullcounter_transfer_invalid_output_data()
{
	// Create Context
	let mut context = Context::default();
	...
	// Run
	let err = context.verify_tx(&tx, MAX_CYCLES).unwrap_err();
	assert_error_eq!(err, ScriptError::ValidationFailure(ERROR_FULLCOUNTER_INVALID_OUTPUT_CELL_DATA).input_type_script(0));
}
